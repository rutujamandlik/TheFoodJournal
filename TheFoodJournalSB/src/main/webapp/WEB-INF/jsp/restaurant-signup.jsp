	...
	<form class="modal-content" action="/myapp/create-profile"
		...
		<div class="container">
			...
			<label for="username"><b>Enter Username</b></label> <input
				...
				<label for="fullname"><b>Enter Full Name</b></label> <input type="text"
			...
			<label> <input type="checkbox" checked="checked" name="role"
				id="role" value="Rest_Owner" style="margin-bottom: 15px"> I
				am new Restaurant Owner
