...
<header>
  ...
  <nav>
    <ul>
      ...
      <li style="float:right"><a href="/myapp/aboutme">About</a></li>
    </ul>
  </nav>
	 ...
	 <div class="row row-cols-2 row-cols-md-3 g-2">
		 ...
		 <form action="/myapp/display-restaurant?rest_id=${rest.rest_id}" method="post">
		 <div class="col">
				<div class="card">
				  ...
				  <p>${rest.city}</p>
				  <p><input type="submit" id="button" value="Visit"></p>
				</div>
		</div>
		</form>	
		</c:forEach>
